    ...
    return (
      <div className="projects">
        ...
        <div className="projects__content">
          <p className="fs_16">A <a href="https://jsbench.me/user/klimcode">collection</a> of JavaScript functions performance comparisons</p>
          ...
          <p className="fs_16_low"><a href="http://klimov.site/elmar/">A website</a> for Elmar Ipskamp, an artist from Netherlands. It uses Blogger for storing data.</p>
